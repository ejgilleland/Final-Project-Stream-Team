  ...
  const currentScreen = [
      ...
      <div className="padding-1rem margin-top-1rem" key={0}>
        <form onSubmit={props.submit} className="padding-1rem">
          <label htmlFor="streamer-url">
            <h3 className="header-font margin-0 margin-bottom-1rem ">Please enter a channel&apos;s URL</h3>
          </label>
          <input className="width-90pct margin-top-1rem margin-bottom-1rem body-font font-size-inherit"
    ...
    (
      <div key={3}>
        <div className="flex-80">
          <h3 className="header-font margin-0 margin-bottom-halfrem">Is this the correct profile?</h3>
        ...
        <ul className="flex liststyle-none flex flex-20 padding-0 margin-top-1rem
          ...
          <li className="flex-10">
            <button className="button margin-top-1rem margin-lr-1rem font-size-inherit body-font
            border-radius padding-button font-black background-gray border" onClick={props.clickYes}>
              Yes
            </button>
          </li>
          <li className="flex-10">
            <button className="button margin-top-1rem margin-lr-1rem font-size-inherit body-font
            border-radius padding-button font-black background-gray border" onClick={props.clickReset}>
              No
            </button>
          </li>
        </ul>
    ...
    (
      <div className="flex column flex-80" key={3}>
        ...
        <div className="flex-80">
          <h3 className="header-font margin-0 margin-top-1rem margin-bottom-1rem">An error has occurred:</h3>
        ...
        <ul className="flex liststyle-none padding-0 padding-bottom-0 flex-80
          ...
          <li className="flex-10">
            <button className="button margin-top-1rem  font-size-inherit body-font
            border-radius padding-button font-black background-gray border" onClick={props.clickClose}>
              No
            </button>
          </li>
        </ul>
